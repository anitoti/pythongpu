...
Run:
    python3 src/pythongpu/lorenz_vps_clustering.py
    python3 src/pythongpu/lorenz_vps_clustering.py \
...
def main():
    ...
    plt.tight_layout()
    plt.savefig(out_dir / "elbow_curve.png", dpi=150)
    plt.close(fig_el)
    ...
    plt.tight_layout()
    plt.close(fig_bm)
    plt.savefig(out_dir / "basin_map_kmeans.png", dpi=150)
    ...
    plt.tight_layout()
    plt.savefig(out_dir / "basin_boundary.png", dpi=150)
    plt.close(fig_bd)
    ...
    plt.tight_layout()
    plt.savefig(out_dir / "boxcount_loglog.png", dpi=150)
    plt.close(fig_bc)
    ...
    ax_bx.axis("off")
    plt.tight_layout()
    plt.savefig(out_dir / "boxdiv2_synthetic.png", dpi=150)
    plt.close(fig_bx)
    ...
    for ax in axes:
        ax.axis("off")
    plt.tight_layout()
    plt.savefig(out_dir / "rewired_adjacency.png", dpi=150)
    plt.close(fig_rw)
